#[test_only]
module defiralia_staking::stake_decimals_tests {
    ...
    use defiralia_staking::stake_test_helpers::{
        new_account,
    ...
    public fun test_reward_calculation_decimals_s0_r0() {
        ...
        let defiralia_staking_acc = new_account(@defiralia_staking);

        initialize_stake_coin(&defiralia_staking_acc, 0);
        initialize_reward_coin(&defiralia_staking_acc, 0);
        ...
        stake::register_pool<StakeCoin, RewardCoin>(&defiralia_staking_acc, reward_coins, duration, option::none());
        ...
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 49, 1);
        ...
        let coins =
            stake::unstake<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, 20);
        ...
        // 3024000 RewardCoins
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 3024000, 1);
        ...
        let coins =
            stake::unstake<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, 9);
        coin::deposit<StakeCoin>(@alice, coins);
        ...
        // 3024050 RewardCoins
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 3024050, 1);
    ...
    public fun test_reward_calculation_decimals_s2_r8() {
        ...
        initialize_stake_coin(&defiralia_staking_acc, 2);
        initialize_reward_coin(&defiralia_staking_acc, 8);
        ...
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 1999999999, 1);
        ...
        // unstake 20 StakeCoins from alice
        let coins =
            stake::unstake<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, 2000);
        coin::deposit<StakeCoin>(@alice, coins);
        ...
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 120960000000000, 1);
        ...
        let coins =
            stake::unstake<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, 999);
        coin::deposit<StakeCoin>(@alice, coins);
        ...
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 120962000000000, 1);
    ...
    public fun test_reward_calculation_decimals_s6_r10() {
        ...
        initialize_stake_coin(&defiralia_staking_acc, 6);
        initialize_reward_coin(&defiralia_staking_acc, 10);
        ...
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 99999999999, 1);
        ...
        // unstake 20 StakeCoins from alice
        let coins =
            stake::unstake<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, 20000000);
        coin::deposit<StakeCoin>(@alice, coins);
        ...
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 6048000000000000, 1);
        ...
        let coins =
            stake::unstake<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, 9999999);
        coin::deposit<StakeCoin>(@alice, coins);
        ...
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 6048100000000000, 1);
    ...
    public fun test_reward_calculation_decimals_s8_r2() {
        ...
        initialize_stake_coin(&defiralia_staking_acc, 8);
        initialize_reward_coin(&defiralia_staking_acc, 2);
        ...
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 3499, 1);
        ...
        // unstake 20 StakeCoins from alice
        let coins =
            stake::unstake<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, 2000000000);
        coin::deposit<StakeCoin>(@alice, coins);
        ...
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 211680000, 1);
        ...
        let coins =
            stake::unstake<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, 999999999);
        coin::deposit<StakeCoin>(@alice, coins);
        ...
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 211683500, 1);
    ...
    public fun test_reward_calculation_case_1() {
        ...
        // acc_reward * stake_amount
        // 15 RewardCoins
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 15, 1);
        ...
        stake::stake<StakeCoin, RewardCoin>(&carol_acc, @defiralia_staking, coins);
        ...
        // acc_reward * stake_amount
        // 25 RewardCoins
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice) == 25, 1);
        ...
        // 15 RewardCoins
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @bob) == 15, 1);

        // check carol stake parameters
        let unobtainable_reward =
            stake::get_unobtainable_reward<StakeCoin, RewardCoin>(@defiralia_staking, @0x1234);
        // acc_reward * stake_amount
        // 12 RewardCoins
        assert!(unobtainable_reward == 12, 1);
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @0x1234) == 0, 1);
    ...
    fun test_register_with_10_decimals_reward_coin_works() {
        ...
        initialize_reward_coin(&defiralia_staking, 10);
    ...
    fun test_register_with_invalid_reward_decimals_fails() {
        ...
        // create coins for pool
        initialize_reward_coin(&defiralia_staking, 11);
        initialize_stake_coin(&defiralia_staking, 6);
