#[test_only]
module lp_staking_admin::staking_tests {
    use std::option;
    use std::string::utf8;
    ...
    use defiralia_staking::stake_test_helpers::{Self, new_account};
    ...
    #[test]
    fun test_defiralia_staking_e2e() {
        ...
        let defiralia_staking_acc = stake_test_helpers::new_account(@harvest);
        ...
        coin::register<AptosCoin>(&defiralia_staking_acc);
        ...
        router::register_pool<BTC, USDT, Uncorrelated>(&defiralia_staking_acc);
        ...
        let aptos_coins = coin::withdraw<AptosCoin>(&defiralia_staking_acc, 50000000000);
        let duration = 5000000;
        stake::register_pool<LP<BTC, USDT, Uncorrelated>, AptosCoin>(&defiralia_staking_acc,
