#[test_only]
module defiralia_staking::stake_nft_tests {
    use std::option;
    ...
    use defiralia_staking::stake_test_helpers::{new_account, StakeCoin, RewardCoin, new_account_with_stake_coins, mint_default_coin};
    ...
    public fun test_boost_and_remove_boost() {
        ...
        stake::register_pool<StakeCoin, RewardCoin>(&defiralia_staking, reward_coins, duration, option::some(boost_config));
        ...
        stake::boost<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, nft);
        ...
        let pending_rewards = stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice);
        assert!(pending_rewards == 9999999, 1);

        // remove nft boost
        let nft = stake::remove_boost<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking);
    ...
    public fun test_reward_calculation_with_boost() {
        ...
        stake::boost<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, nft_1);

        // wait one week seconds
        timestamp::update_global_time_for_test_secs(START_TIME + WEEK_IN_SECONDS);

        let pending_rewards_1 = stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @alice);
        let pending_rewards_2 = stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@defiralia_staking, @bob);
        assert!(pending_rewards_1 == 403200000000, 1);
        assert!(pending_rewards_2 == 201600000000, 1);

        // unstake 50 StakeCoins from alice
        let coins = stake::unstake<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, 50000000);
        coin::deposit(@alice, coins);

        // boost stake with nft from bob
        stake::boost<StakeCoin, RewardCoin>(&bob_acc, @defiralia_staking, nft_2);
        ...
        let nft_2 = stake::remove_boost<StakeCoin, RewardCoin>(&bob_acc, @defiralia_staking);
        ...
        let rewards_1 = stake::harvest<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking);
        let rewards_2 = stake::harvest<StakeCoin, RewardCoin>(&bob_acc, @defiralia_staking);
    ...
    public fun test_boosted_amount_calculation() {
        ...
        // check values
        let total_boosted = stake::get_pool_total_boosted<StakeCoin, RewardCoin>(@defiralia_staking);
        let user_boosted = stake::get_user_boosted<StakeCoin, RewardCoin>(@defiralia_staking, @bob);
        ...
        let coins =
            stake::unstake<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, 255000000);
        coin::deposit(@alice, coins);
    ...
    public fun test_is_boostable() {
        ...
        let duration = 15768000;
        stake::register_pool<RewardCoin, StakeCoin>(&defiralia_staking, reward_coins, duration, option::none());

        // check is boostable
        assert!(stake::is_boostable<StakeCoin, RewardCoin>(@defiralia_staking), 1);
        assert!(!stake::is_boostable<RewardCoin, StakeCoin>(@defiralia_staking), 1);
    }
    ...
    public fun test_is_boosted() {
        ...
        assert!(!stake::is_boosted<StakeCoin, RewardCoin>(@defiralia_staking, @alice), 1);
    ...
    public fun test_boost_fails_if_pool_does_not_exist() {
        ...
        stake::boost<StakeCoin, RewardCoin>(&defiralia_staking, @defiralia_staking, nft);
    }
    ...
    public fun test_remove_boost_fails_if_pool_does_not_exist() {
        ...
        let nft = stake::remove_boost<StakeCoin, RewardCoin>(&defiralia_staking, @defiralia_staking);
        token::deposit_token(&defiralia_staking, nft);
    }

    #[test]
    #[expected_failure(abort_code = stake::ERR_NO_POOL)]
    public fun test_is_boostable_fails_if_pool_does_not_exist() {
        stake::is_boostable<StakeCoin, RewardCoin>(@defiralia_staking);
    }
    ...
    public fun test_get_pool_total_boosted_fails_if_pool_does_not_exist() {
        stake::get_pool_total_boosted<StakeCoin, RewardCoin>(@defiralia_staking);
    }

    #[test]
    #[expected_failure(abort_code = stake::ERR_NO_POOL)]
    public fun test_is_boosted_fails_if_pool_does_not_exist() {
        stake::is_boosted<StakeCoin, RewardCoin>(@defiralia_staking, @alice);
    }

    #[test]
    #[expected_failure(abort_code = stake::ERR_NO_POOL)]
    public fun test_get_user_boosted_fails_if_pool_does_not_exist() {
        stake::get_user_boosted<StakeCoin, RewardCoin>(@defiralia_staking, @alice);
    }
    ...
    public fun test_create_boost_config_fails_if_colleciont_does_not_exist_1() {
        ...
        stake::register_pool<StakeCoin, RewardCoin>(&defiralia_staking, coin::zero<RewardCoin>(), 12345, option::some(boost_config));
    }
    ...
    public fun test_boost_fails_if_already_boosted() {
        ...
        stake::boost<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, nft_1);
        stake::boost<StakeCoin, RewardCoin>(&alice_acc, @defiralia_staking, nft_2);
    }
    ...
    public fun test_boost_fails_if_amount_more_than_one() {
        ...
        stake::boost<StakeCoin, RewardCoin>(&bob_acc, @defiralia_staking, nft);
    }
    ...
    public fun test_stake_and_boost_two_accounts_in_time() {
        ...
        let nft = stake::remove_boost<StakeCoin, RewardCoin>(&bob_acc, @defiralia_staking);
    ...
    public fun test_stake_and_boost_two_accounts_and_unstake() {
        ...
        let stake_coins = stake::unstake<StakeCoin, RewardCoin>(&bob_acc, @defiralia_staking, 500000000);
